    ...
    <div className="flex flex-col gap-1">
      {showScale && (
        <div className="flex items-center justify-between text-xs text-[--color-ink-soft]">
          ...
          <span className="font-mono font-semibold tabular-nums text-[--color-ink]">
            {clamped.toFixed(1)}
          </span>
        </div>
      )}
      ...
      <div
        className="relative h-2 overflow-hidden rounded-full bg-[--color-surface-2]"
        role="meter"
      ...
      >
        ...
        />
        <div
          className="absolute inset-y-0 w-px bg-[--color-ink-faint]"
