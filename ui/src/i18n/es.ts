...
export const es = {
  ...
  sources: {
    ...
    languages: "Idiomas",
    scan: "Escanear",
    estimating: "Estimando el gasto de Gemini…",
    confirmTitle: "Antes de escanear: gasto estimado de Gemini",
    confirmEstimated:
      "Son estimaciones: antes de escanear no se sabe cuántas piezas pasarán el filtro. Los topes cortan cualquier exceso.",
    confirmCalls: "Llamadas de este escaneo: {calls}",
    confirmTokens: "Tokens de este escaneo: {tokens}",
    confirmSpent: "Gastado hoy: {calls} llamadas · {tokens} tokens",
    confirmLeft: "Queda hoy: {calls} llamadas · {tokens} tokens",
    confirmWithHistory: "Tokens según la media de tus llamadas anteriores.",
    confirmNoHistory: "Sin historial todavía: tokens según lo más alto medido (25.000 por llamada).",
    confirmNoBudget:
      "Hoy no queda presupuesto de Gemini. Súbelo en Configuración › Presupuesto de Gemini o espera a mañana (hora de Lima).",
    confirmScan: "Confirmar y escanear",
    confirmCancel: "No escanear",
    scanning: "Escaneando…",
