...
export const es = {
  ...
  modos: {
    ...
    software: {
      ...
      ejemplos: "clientes que pagan tarde · turnos de un restaurante · alquilar sin fiador",
  ...
  nuevoEscaneo: {
    ...
    seguirIgual: "Seguir de todos modos",
    ...
    costeLlamadas: "Entre {min} y {max} llamadas",
    costeUnidades: "Entre {min} y {max} unidades de texto",
