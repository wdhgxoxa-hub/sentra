...
export const en: Dictionary = {
  ...
  modos: {
    ...
    software: {
      ...
      ejemplos: "clients who pay late · restaurant shift planning · renting without a guarantor",
  ...
  nuevoEscaneo: {
    ...
    costeLlamadas: "Between {min} and {max} calls",
    costeUnidades: "Between {min} and {max} text units",
